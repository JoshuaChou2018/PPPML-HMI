...
array_0 = converter.dcm_to_spatial_rescaled('/home/zhoul0a/Desktop/KFSH/breast_cancer/raw_data/3979903-20211109T154119Z-001/3979903/DCE-MRI/ser006- t1_fl3d_tra_dynaVIEWS_spair_8+1',
                                            target_shape=(464, 464, 240), target_resolution=(0.75, 0.75, 0.75), tissue='breast')

print(np.shape(array_0))

array_2 = converter.dcm_to_spatial_rescaled('/home/zhoul0a/Desktop/KFSH/breast_cancer/raw_data/3979903-20211109T154119Z-001/3979903/DCE-MRI/ser014- t1_fl3d_tra_dynaVIEWS_spair_8+1',
                                            target_shape=(464, 464, 240), target_resolution=(0.75, 0.75, 0.75), tissue='breast')

print(np.shape(array_2))

array_4 = converter.dcm_to_spatial_rescaled('/home/zhoul0a/Desktop/KFSH/breast_cancer/raw_data/3979903-20211109T154119Z-001/3979903/DCE-MRI/ser022- t1_fl3d_tra_dynaVIEWS_spair_8+1',
                                            target_shape=(464, 464, 240), target_resolution=(0.75, 0.75, 0.75), tissue='breast')
...
Functions.image_show(rescaled_array[:, :, 120, 0])
Functions.image_show(rescaled_array[:, :, 120, 1])
Functions.image_show(rescaled_array[:, :, 120, 2])
...
Functions.merge_image_with_mask(rescaled_array[:, :, z_mid, 0], mask[:, :, z_mid], save_path='/home/zhoul0a/Desktop/KFSH/breast_cancer/visualize/3979903.png')
