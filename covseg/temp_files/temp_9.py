...
array_0 = converter.dcm_to_spatial_rescaled('/home/zhoul0a/Desktop/KFSH/breast_cancer/raw_data/3176336-20211109T154150Z-001/3176336/DCE-MRI/ser007- T1_fl3d_tra_dynaVIEWS_spair_8+1/',
                                            target_shape=(464, 464, 240), target_resolution=(0.75, 0.75, 0.75), tissue='breast')

print(np.shape(array_0))

array_2 = converter.dcm_to_spatial_rescaled('/home/zhoul0a/Desktop/KFSH/breast_cancer/raw_data/3176336-20211109T154150Z-001/3176336/DCE-MRI/ser015- T1_fl3d_tra_dynaVIEWS_spair_8+1/',
                                            target_shape=(464, 464, 240), target_resolution=(0.75, 0.75, 0.75), tissue='breast')

print(np.shape(array_2))

array_4 = converter.dcm_to_spatial_rescaled('/home/zhoul0a/Desktop/KFSH/breast_cancer/raw_data/3176336-20211109T154150Z-001/3176336/DCE-MRI/ser023- T1_fl3d_tra_dynaVIEWS_spair_8+1/',
                                            target_shape=(464, 464, 240), target_resolution=(0.75, 0.75, 0.75), tissue='breast')
...
Functions.merge_image_with_mask(rescaled_array[:, :, z_mid, 0], mask[:, :, z_mid], save_path='/home/zhoul0a/Desktop/KFSH/breast_cancer/visualize/3176336.png')
