...
def rescale_ct_gt_all_parallel(root_dict, save_dict_ct, save_dict_gt, parallel_count=24):
    ...
    :return: None
    """
    if os.path.isdir(save_dict_ct)==False:
        os.system(f'mkdir {save_dict_ct}')
    if os.path.isdir(save_dict_gt)==False:
        os.system(f'mkdir {save_dict_gt}')
    input_list = []
