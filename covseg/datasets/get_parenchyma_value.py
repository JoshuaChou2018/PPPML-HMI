...
array_name_set = set(os.listdir('/home/zhoul0a/Desktop/COVID-19 delta/visualization/lesion_mid_z'))
blood_high_quality_set = set(os.listdir('/home/zhoul0a/Desktop/COVID-19 delta/visualization/blood_250'))
lung_high_quality_set = set(os.listdir('/home/zhoul0a/Desktop/COVID-19 delta/visualization/lung_250'))

array_name_set = array_name_set & blood_high_quality_set & lung_high_quality_set
...
if os.path.exists('/home/zhoul0a/Desktop/COVID-19 delta/dataset/parenchyma_delta.pickle'):
...
for array_name in array_name_set:
    ...
    Functions.pickle_save_object('/home/zhoul0a/Desktop/COVID-19 delta/dataset/parenchyma_delta.pickle',
                                 parenchyma_dict)
    processed += 1
