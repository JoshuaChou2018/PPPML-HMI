...
dataset = Functions.pickle_load_object('/home/zhoul0a/Desktop/longxi_platform/delat_project/dataset_1017.pickle')
...
for patient in patient_id_list:
    if dataset[patient][1]['static'] >= 1:
        count += 1
        print(dataset[patient][0])
print(count)
exit()
