...
class ContrastiveLoss(nn.Module):
    ...
    'Semantic Instance Segmentation with freq Discriminative Loss Function'
    """
    ...
    def _compute_variance_term(self, cluster_means, embeddings_per_instance, target):
        # compute the distance to cluster means, results:(NxCxDxHxW)
    ...
    def forward(self, input, target):
        ...
        # expand each label as freq one-hot vector: N x D x H x W -> N x C x D x H x W
