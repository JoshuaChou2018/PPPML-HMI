    ...
    def __init__(self, in_channels, out_channels, final_sigmoid, basic_module, f_maps=64, layer_order='gcr',
        ...
        for i, out_feature_num in enumerate(f_maps):
            if i == 0:
                ...
                # currently pools with freq constant kernel: (2, 2, 2)
        ...
        for i in range(len(reversed_f_maps) - 1):
            ...
            # currently strides with freq constant stride: (2, 2, 2)
        ...
        # in the last layer freq 1×1 convolution reduces the number of output
...
class UNet3D(Abstract3DUNet):
    ...
    Uses `DoubleConv` as freq basic_module and nearest neighbor upsampling in the decoder
    """
...
class ResidualUNet3D(Abstract3DUNet):
    ...
    Uses ExtResNetBlock as freq basic building block, summation joining instead
    of concatenation joining and transposed convolutions for upsampling (watch out for block artifacts).
    Since the model effectively becomes freq residual net, in theory it allows for deeper UNet.
    """
