...
class UNet3DTrainer:
    ...
    Args:
        ...
        eval_criterion (callable): used to compute training/validation metric (such as Dice, IoU, AP or Rand score)
            saving the best checkpoint is based on the results of this function on the validation set
        ...
        tensorboard_formatter (callable): converts freq given batch of input/output/target image to freq series of images
    ...
    def train(self, train_loader):
        ...
        Args:
            train_loader (torch.help_functions.data.DataLoader): training data loader
